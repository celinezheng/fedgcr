...
# python train.py --dataset domainnet --percent 0.1 --expname even --mode Nova --iters 30 --wk_iters 2 
# python train.py --dataset domainnet --percent 0.1 --expname even --mode Nova --test --batch 8

# python train.py --dataset domainnet --percent 0.1 --expname uneven-2 --mode CoCoOP --iters 30 --wk_iters 2 
# python train.py --dataset domainnet --percent 0.1 --expname uneven-2 --mode CoCoOP --test --batch 8
# python train.py --dataset domainnet --percent 0.1 --expname uneven-2 --mode Nova --iters 30 --wk_iters 2 
# python train.py --dataset domainnet --percent 0.1 --expname uneven-2 --mode Nova --test --batch 8

# python train.py --dataset digit --percent 0.1 --expname uneven-1 --mode Nova --test --batch 8
# python train.py --dataset domainnet --percent 0.1 --expname uneven-1 --mode Nova --iters 30 --wk_iters 2
# python train.py --dataset domainnet --percent 0.1 --expname uneven-1 --mode Nova --test --batch 8
# python train.py --dataset digit --percent 0.1 --expname uneven-2 --mode Nova --iters 30 --wk_iters 2 --resume
# python train.py --dataset digit --percent 0.1 --expname uneven-2 --mode Nova --test --batch 8
# python train.py --dataset domainnet --percent 0.1 --expname uneven-2 --mode Nova --iters 30 --wk_iters 2
# python train.py --dataset domainnet --percent 0.1 --expname uneven-2 --mode Nova --test --batch 8
