...
python train.py --dataset digit --percent 0.1 --expname even --mode full --iters 50 --wk_iters 1
python train.py --dataset digit --percent 0.1 --expname even --mode full --test --batch 1 
...
python train.py --dataset digit --percent 0.1 --expname even --mode q-ffl --iters 50 --wk_iters 1
python train.py --dataset digit --percent 0.1 --expname even --mode q-ffl --test --batch 1 

python train.py --dataset digit --percent 0.1 --expname uneven-1 --mode full --iters 50 --wk_iters 1
python train.py --dataset digit --percent 0.1 --expname uneven-1 --mode full --test --batch 1 
...
python train.py --dataset digit --percent 0.1 --expname uneven-2 --mode full --iters 50 --wk_iters 1
python train.py --dataset digit --percent 0.1 --expname uneven-2 --mode full --test --batch 1 
...
python train.py --dataset digit --percent 0.1 --expname uneven-2 --mode q-ffl --iters 50 --wk_iters 1
python train.py --dataset digit --percent 0.1 --expname uneven-2 --mode q-ffl --test --batch 1 

python train.py --dataset domainnet --percent 0.2 --expname even --mode full --iters 50 --wk_iters 1
...
python train.py --dataset domainnet --percent 0.2 --expname uneven-2 --mode full --iters 50 --wk_iters 1
python train.py --dataset domainnet --percent 0.2 --expname uneven-2 --mode full --test --batch 1 
