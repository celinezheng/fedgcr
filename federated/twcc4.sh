# python train.py --dataset digit --percent 0.5 --ratio 1.5 --expname uneven --mode fedavg --iters 50 --batch 64 --test_freq 51
# python train.py --dataset digit --percent 0.5 --ratio 1.5 --expname uneven --mode fedavg --test --batch 64
# python train.py --dataset digit --percent 0.5 --ratio 1.5 --expname uneven --mode afl --iters 50 --batch 64 --test_freq 51
# python train.py --dataset digit --percent 0.5 --ratio 1.5 --expname uneven --mode afl --test --batch 64
