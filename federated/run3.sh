...
python train.py --dataset fairface --percent 0.5 --expname even --mode ccop --iters 50 --gender_dis random_dis --cluster_num 7  --batch 16
python train.py --dataset fairface --percent 0.5 --expname even --mode ccop --test --gender_dis random_dis --cluster_num 7 
python train.py --dataset fairface --percent 0.5 --expname even --mode CoCoOP --iters 50 --gender_dis random_dis --batch 16
python train.py --dataset fairface --percent 0.5 --expname even --mode CoCoOP --test --gender_dis random_dis
python train.py --dataset fairface --percent 0.5 --expname even --mode fedavg --iters 50 --gender_dis random_dis --batch 16
python train.py --dataset fairface --percent 0.5 --expname even --mode fedavg --test --gender_dis random_dis
